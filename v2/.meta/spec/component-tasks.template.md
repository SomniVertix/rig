...
<!-- Concerns, gaps, or assumptions encountered while breaking the design into tasks
     ...
     TODO: We need a new place to put flags that come up while implementing the tasks 
     themselves. This way the agent can call out clear issues as its implementing through the tasks
