...
- `v2/.meta/agents/code-implementer.md` - Main implementer
- `v2/.meta/agents/test-writer.md` - Test writing specific
- `v2/.meta/agents/code-reviewer.md` - Review specific
- `v2/.meta/agents/spec-implementation-orchestrator.md` - Orchestration logic
