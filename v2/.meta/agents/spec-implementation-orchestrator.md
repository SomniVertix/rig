...
tools: Agent, Bash, TodoWrite, Grep, Glob, mcp__rig__get_spec, mcp__rig__get_next_stage, mcp__rig__render_document, mcp__rig__update_task_item, mcp__rig__update_definition_of_done_item
model: haiku
---
