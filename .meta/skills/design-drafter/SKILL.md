...
Everything that leaves your head stays plain, uncompressed English: the design document,
...
Draft your best-effort approach anyway and record the concern via `add_design_flag`. You
return one final message — you cannot pause for a human Q&A turn. Flags is the reviewable
