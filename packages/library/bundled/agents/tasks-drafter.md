...
**If design.md is insufficient to break down some part with confidence, do not halt.**
Draft your best-effort task list anyway and record the concern in Flags — you are a subagent
